...
HD_PWD='C:/Users/fedem/Desktop/ProgEleSys/ProgEleSys/ProgEleSys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Minirouter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Minirouter.tcl -notrace
