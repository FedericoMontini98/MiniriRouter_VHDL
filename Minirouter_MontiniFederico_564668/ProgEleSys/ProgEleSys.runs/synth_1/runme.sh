...
HD_PWD='C:/Users/fedem/Desktop/ProgEleSys/ProgEleSys/ProgEleSys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Minirouter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Minirouter.tcl
